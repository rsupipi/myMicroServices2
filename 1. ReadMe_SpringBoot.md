...
## Create the project:
	...
	![](notes/2_introduction_to_web_services/)
...
![](notes/3_restful_web_services_with_spring_boot/)
...
***SwaggerConfig.java***    <- create a folder call config and create this file
